...
cover: /images/posts/【Google%20Earth%20Studio】基础编辑技巧/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-01.mp4)

### 2\. 时间区间

默认的时间区间是总时间，但很多情况下我们需要在较短的时间间隔内编辑，这样可以拖动编辑区域的时间区间工具条选择合适的时间区间  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-02.mp4)
还可以放大区间，更容易编辑  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-03.mp4)
...
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-04.mp4)

### 2\. 不同时刻的关键帧

首先固定Camera在某一视角，我们在00帧时刻记录当前Camera状态  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-05.mp4)
...
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-06.mp4)

### 3\. 播放动画

已经在开始和结束设置了不同的关键帧，开始和结束的Camera不一致，所以GES会自动填补两个关键帧中间的动画  
点击播放按钮，查看动画  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-07.mp4)
也可以鼠标按住时间线拖动，查看每一帧的情况  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-08.mp4)

### 4\. 回到起始帧的Camera

细心的读者在会发现菱形属性图案在这个过程变成黄色的了，这是因为在GES会自动检测到当前关键帧Camera发生了改变  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-09.mp4)
如果想回到起始的Camera，来回拖动时间线即可  
![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-10.mp4)

## 三、播放菜单

### 1\. 播放选项如图所示

![在这里插入图片描述](/images/posts/【Google%20Earth%20Studio】基础编辑技巧/image-11.webp)
