...
cover: /images/posts/【代码质量】MSBuild%20Log%20Viewer查看MSBuild输出日志/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【代码质量】MSBuild%20Log%20Viewer查看MSBuild输出日志/image-01.webp)

选择打开日志文件， 导入之前生成的二进制文件`D:\Temp\MSBuild_Info.binlog`，左侧是目录树结构，包括项目用到的Window依赖项和项目源码文件，右侧则是具体信息，包括编译用到的变量、花费的时间等各种详细信息

![在这里插入图片描述](/images/posts/【代码质量】MSBuild%20Log%20Viewer查看MSBuild输出日志/image-02.webp)  
点开Timeline选项卡，可以查看项目编译的时间线  
![在这里插入图片描述](/images/posts/【代码质量】MSBuild%20Log%20Viewer查看MSBuild输出日志/image-03.webp)  
还可以查看项目结构图，不过效果似乎不是太好

![在这里插入图片描述](/images/posts/【代码质量】MSBuild%20Log%20Viewer查看MSBuild输出日志/image-04.webp)  
