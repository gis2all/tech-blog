...
cover: /images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-01.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-02.webp)

### 2\. 配置 Jenkins

配置Jenkin 凭据， 也就是上一步生成的Github Token， 凭据类型为 `Secret text` , Secret为上一步保存好的Github Token， Description为Token名字  
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-03.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-04.webp)  
如果Token设置正确，可以看到测试结果类似如下  
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-05.webp)

## 三、配置Github仓库

当通过Token可以验证Github和Jenkins连接时，接下来我们就需要通过webhook具体连接到某个仓库， 转到Github个人名下任意一个仓库`Settings -> Webhooks`

![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-06.webp)  
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-07.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-08.webp)

## 四、使用Smee公用ip

为解决内网Jenkins问题，我们使用smee， **smee是基于nodejs的，所以必须事前安装nodejs**  
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-09.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-10.webp)  
...
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-11.webp)  
我们在配置仓库下的webhook, 发现成功了（Github企业版也许不会成功，它有更复杂的认证机制）  
![在这里插入图片描述](/images/posts/【Jenkins】%20手把手教你如何集成Jenkins和Github/image-12.webp)
