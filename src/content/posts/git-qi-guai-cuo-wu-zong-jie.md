...
cover: /images/posts/git-qi-guai-cuo-wu-zong-jie/cover.webp
coverAlt: 在这里插入图片描述
---
...
-   在本地仓库里打开Git Bash  
    ![在这里插入图片描述](/images/posts/git-qi-guai-cuo-wu-zong-jie/image-01.webp)
-   使用命令删除远端仓库文件

> 注意文件路径，在远端仓库一样按文件组织结构

![在这里插入图片描述](/images/posts/git-qi-guai-cuo-wu-zong-jie/image-02.webp)  
![在这里插入图片描述](/images/posts/git-qi-guai-cuo-wu-zong-jie/image-03.webp)  
![在这里插入图片描述](/images/posts/git-qi-guai-cuo-wu-zong-jie/image-04.webp)
