...
cover: /images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/image-01.webp)  
下载完成后解压压缩包，将其复制或剪切至合适位置。接下来需要将其加入环境变量，首先新建变量`ANT_HOME`，值为解压后的地址  
![在这里插入图片描述](/images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/image-02.webp)  
另外还需在`Path`变量中加入新项，值为 `%ANT_HOME%\bin`  
![在这里插入图片描述](/images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/image-03.webp)  
测试，安装成功则如下所示  
![在这里插入图片描述](/images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/image-04.webp)
...
![在这里插入图片描述](/images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/image-05.webp)
...
![在这里插入图片描述](/images/posts/ant-shi-xian-yu-bat-pi-chu-li-jenkins-ji-cheng-guan-li/image-06.webp)  
