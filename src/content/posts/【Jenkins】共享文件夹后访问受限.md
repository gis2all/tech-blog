...
cover: /images/posts/【Jenkins】共享文件夹后访问受限/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【Jenkins】共享文件夹后访问受限/image-01.webp)

## 二、解决方法

共享文件夹的权限设置为 Sharing → Andvanced Sharing → Permissions → Add…  
添加新用户名 `Everyone`，然后赋予全部权限  
![在这里插入图片描述](/images/posts/【Jenkins】共享文件夹后访问受限/image-02.webp)

![在这里插入图片描述](/images/posts/【Jenkins】共享文件夹后访问受限/image-03.webp)  
