...
cover: /images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-01.webp)  
它的默认登录地址是 `http://localhost:9000/about`，浏览器输入登录

-   用户名： `admin`
-   密码：`admin`  
    ![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-02.webp)
...
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-03.webp)  
...
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-04.webp)  
关于重启`SonarQube`服务，有些无奈💩，没有可以直接使用的命令和操作，只能手动地在任务管理器中结束 Java相关进程，然后再启动 `StartSonar.bat`。经过一番艰难的操作，界面终于变成汉字了，开心 😎

![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-05.webp)

### 2\. 配置第一个项目

创建新项目  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-06.webp)  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-07.webp)  
创建Token，该Token用来与项目对应，**注意要保存好，可以先存到某个文本文件中**

![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-08.webp)  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-09.webp)  
下一步，选择项目的语言，这里我们选择C#项目，按照提示我们需要下载某个程序，然后按照命令行执行就能看到项目代码质量结果  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-10.webp)  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-11.webp)
...
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-12.webp)  
下载解压后放到合适目录，然后将该目录加入`Path`环境变量，这样就可以在cmd中直接使用`SonarScanner.MSBuild.exe`  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-13.webp)
...
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-14.webp)  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-15.webp)
...
项目质量分析结果  
![在这里插入图片描述](/images/posts/【SonarQube】从零搭建.Net%20Core代码质量检查平台/image-16.webp)
