...
![在这里插入图片描述](/images/posts/net-core-dan-yuan-ce-shi-xiang-mu-di-qian-yi/image-01.webp)  
...
![在这里插入图片描述](/images/posts/net-core-dan-yuan-ce-shi-xiang-mu-di-qian-yi/image-02.webp)  
所以比较遗憾， 不能使用该工具进行转换
...
测试项目可移植率  
![在这里插入图片描述](/images/posts/net-core-dan-yuan-ce-shi-xiang-mu-di-qian-yi/image-03.webp)  
不支持部分细节 (有些库并不是不支持`.Net Core`， 而是在项目中没有在依赖中加进来所以显示不支持)  
![在这里插入图片描述](/images/posts/net-core-dan-yuan-ce-shi-xiang-mu-di-qian-yi/image-04.webp)
...
详细说明  
![在这里插入图片描述](/images/posts/net-core-dan-yuan-ce-shi-xiang-mu-di-qian-yi/image-05.webp)
