...
cover: /images/posts/selenium-shi-xian-gui-kong-jian-gao-liang-ce-shi-bao-gao/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/selenium-shi-xian-gui-kong-jian-gao-liang-ce-shi-bao-gao/image-01.webp)  
...
![在这里插入图片描述](/images/posts/selenium-shi-xian-gui-kong-jian-gao-liang-ce-shi-bao-gao/image-02.webp)  
**Client** - 测试脚本，这里我们选择C#语言编写，需要在Nuget里引用`Selenium.WebDriver`

![在这里插入图片描述](/images/posts/selenium-shi-xian-gui-kong-jian-gao-liang-ce-shi-bao-gao/image-03.webp)
...
![在这里插入图片描述](/images/posts/selenium-shi-xian-gui-kong-jian-gao-liang-ce-shi-bao-gao/image-04.webp)  
![在这里插入图片描述](/images/posts/selenium-shi-xian-gui-kong-jian-gao-liang-ce-shi-bao-gao/image-05.webp)
