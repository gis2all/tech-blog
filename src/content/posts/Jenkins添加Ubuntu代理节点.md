...
cover: /images/posts/Jenkins添加Ubuntu代理节点/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-01.webp)  
...
![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-02.webp)
...
![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-03.webp)
...
![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-04.webp)  
**指定Java可执行文件路径**，连接后Jenkins使用Java命令就会往Ubunt的工作目录里面拷贝remoting.jar等相关包，达到控制代理节点的目的

-   Java路径：ubutnu上java可执行文件路几名

![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-05.webp)

连接效果如下

![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-06.webp)  
![在这里插入图片描述](/images/posts/Jenkins添加Ubuntu代理节点/image-07.webp)
