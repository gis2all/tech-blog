...
cover: /images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/image-01.webp)  
...
![在这里插入图片描述](/images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/image-02.webp)  
然后选择语言，选择C#。这里的设置包括单元测试文件和代码覆盖率，我们使用的都是Visual Studio平台，这里选择VS，关于文件路径这里我是写死的，因为不知道为什么写相对路径找不到文件，所以目前先将就一下  
![在这里插入图片描述](/images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/image-03.webp)  
![在这里插入图片描述](/images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/image-04.webp)  
这样服务端都配置好了，接下来配置脚本
...
![在这里插入图片描述](/images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/image-05.webp)  
...
![在这里插入图片描述](/images/posts/【SonarQube】集成.Net%20Core项目单元测试和代码覆盖率/image-06.webp)  
