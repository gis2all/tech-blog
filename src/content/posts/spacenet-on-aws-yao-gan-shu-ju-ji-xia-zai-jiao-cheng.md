...
cover: /images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-01.webp)

### 3\. 添加信用卡

`AWS`登录`S3`服务需要添加信用卡。现在`AWS`支持国内的信用卡，所以不用大费周折去弄国际信用卡，这里我们添加自己的信用卡，用人民币结账就行  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-02.webp)  
如果这一步失败的话，后面的文字就不用看了

### 4\. 登录成功

登录成功如下所示  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-03.webp)

## 二、创建用户

### 1\. 新建用户

![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-04.webp)  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-05.webp)
...
-   用户名： `SpaceNet-2`
-   访问类型： `编程访问`  
    ![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-06.webp)

#### 2.2 设置权限

选择`直接附加到现有策略`，因为数据集是存放在`S3`服务上，所以这里搜索所有`S3`策略给创建的用户  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-07.webp)
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-08.webp)
...
![这里写图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-09.webp)  
`CMD`测试 :
...
![这里写图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-10.webp)  
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-11.webp)
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-12.webp)  
我们需要的是`感兴趣区域AOIs`
...
**错误信息**  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-13.webp)  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-14.webp)  
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-15.webp)  
**解决方法**
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-16.webp)
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-17.webp)  
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-18.webp)
...
![在这里插入图片描述](/images/posts/spacenet-on-aws-yao-gan-shu-ju-ji-xia-zai-jiao-cheng/image-19.webp)  
