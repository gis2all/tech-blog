...
cover: /images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-01.webp)
...
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-02.webp)  
例如我的项目会用到这些包，我就需要找到这些包的 nuget索引文件，一般电脑上nuget包存储的地方位于 `C:\Users\<username>\.nuget\packages` ，定位到这个包文件  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-03.webp)  
登录之后选择上传文件， 选择 nuget-hosted, 选择刚刚框住的以`.nupkg`结尾的文件  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-04.webp)  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-05.webp)

重复上述操作，导入所有用到的包， 可以在Search -&gt; Nuget 页面查看所有包  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-06.webp)  
单独点击每个包，可以查看相关信息，以及如何下载使用和一些属性信息  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-07.webp)  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-08.webp)  
![在这里插入图片描述](/images/posts/shi-yong-nexus-repository-manager-guan-li-nuget-bao/image-09.webp)
