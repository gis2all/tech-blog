...
cover: /images/posts/pao-qi-vmware-workstation-shi-yong-hyper-v-guan-li-qi-ba/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/pao-qi-vmware-workstation-shi-yong-hyper-v-guan-li-qi-ba/image-01.webp)  
确保Win10已启用 Hyper-V功能  
![在这里插入图片描述](/images/posts/pao-qi-vmware-workstation-shi-yong-hyper-v-guan-li-qi-ba/image-02.webp)  
创建虚拟机也很方便， 只需事先准备好要安装的镜像文件即可(`.iso`文件)，接下来一步步操作就可以  
![在这里插入图片描述](/images/posts/pao-qi-vmware-workstation-shi-yong-hyper-v-guan-li-qi-ba/image-03.webp)  
以Win10虚拟机为例，这是效果, 不仅启动和连接速度快，而且可以完美全屏显示  
![在这里插入图片描述](/images/posts/pao-qi-vmware-workstation-shi-yong-hyper-v-guan-li-qi-ba/image-04.webp)
...
![](/images/posts/pao-qi-vmware-workstation-shi-yong-hyper-v-guan-li-qi-ba/image-05.webp)
