...
cover: /images/posts/【Jenkins】参数化选择Git分支/cover.webp
coverAlt: 在这里插入图片描述
...
![在这里插入图片描述](/images/posts/【Jenkins】参数化选择Git分支/image-01.webp)  
...
![在这里插入图片描述](/images/posts/【Jenkins】参数化选择Git分支/image-02.webp)

#### 二、参数化构建

在项目上选择 `Build with Parameters`  
![在这里插入图片描述](/images/posts/【Jenkins】参数化选择Git分支/image-03.webp)  
然后输入分支名  
![在这里插入图片描述](/images/posts/【Jenkins】参数化选择Git分支/image-04.webp)  
