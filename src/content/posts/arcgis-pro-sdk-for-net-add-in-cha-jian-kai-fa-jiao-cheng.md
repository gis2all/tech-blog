...
cover: /images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-01.webp)
...
`Tab`  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-02.webp)  
`Group`  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-03.webp)  
`Menu`  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-04.webp)  
`Control`  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-05.webp)  
控件结构关系  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-06.webp)  
`Daml`结构  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-07.webp)  
...
使用方式(默认为白色主题)  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-08.webp)

### 4\. 创建Module

新建一个`Add-in`项目后会自动创建`Module`，这部分代码可以不改变

![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-09.webp)  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-10.webp)

## 三、Add-in安装

添加一个`Button`标签, 并在`Group`中引用该`Button`, 修改`Config.daml`代码如下  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-11.webp)  
新建`AddDataButton.cs`类，继承自Pro SDK的`button`  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-12.webp)  
编译项目  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-13.webp)  
在项目的bin目录下会生成一个`.esriAddinX`的文件，双击进行安装  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-14.webp)  
重启`ArcGIS Pro`, 就可以发现插件  
![在这里插入图片描述](/images/posts/arcgis-pro-sdk-for-net-add-in-cha-jian-kai-fa-jiao-cheng/image-15.webp)
