...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-01.webp)  
`Appium`运行测试环境包括
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-02.webp)
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-03.webp)
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-04.webp)  
需要开启模拟器硬件加速设置
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-05.webp)

#### 2.1 Android SDK安装

进入`Visual Studio 2019`，打开`Android`选项，首先配置`Android SDK`  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-06.webp)  
选择`Android`版本以及`SDK Build Tools`  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-07.webp)  
安装好之后所有工具都在`Android SDK`目录

> C:\\Program Files (x86)\\Android\\android-sdk

接下来，我们可以新建虚拟设备，打开`Android Device Manager`，在里面新建自己需要的设备，我们可以在这里启动虚拟设备  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-08.webp)  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-09.webp)
...
首先需要编辑配置文件设置环境变量  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-10.webp)  
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-11.webp)  
在`Desired Capbilities`选择，对于`Android`而言有6个必需的参数，`Appium`知道以下参数才能在虚拟设备中找到某个App  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-12.webp)
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-13.webp)  
...
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-14.webp)

### 3\. 启动Session

启动后可以看到虚拟设备中的`拨号功能app`  
![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-15.webp)

## 五、脑图总结

![在这里插入图片描述](/images/posts/【Appium】从零搭建Android自动化测试环境/image-16.webp)
