...
cover: /images/posts/【Docker】使用Docker编译%20.NetCore项目/cover.webp
coverAlt: 在这里插入图片描述
---
...
Publish生成的文件如下  
![在这里插入图片描述](/images/posts/【Docker】使用Docker编译%20.NetCore项目/image-01.webp)  
Dockerfile的内容如下
...
![在这里插入图片描述](/images/posts/【Docker】使用Docker编译%20.NetCore项目/image-02.webp)  
启动新镜像中任意一个Container
...
查看结果  
![在这里插入图片描述](/images/posts/【Docker】使用Docker编译%20.NetCore项目/image-03.webp)
