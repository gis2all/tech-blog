...
cover: /images/posts/【Jenkins】Pull%20Request触发项目构建/cover.webp
coverAlt: 在这里插入图片描述
...
**1\. Jenkin安装插件**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-01.webp)  
**2\. 配置插件**
...
正确结果如图所示  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-02.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-03.webp)  
...
**6\. 若成功，则如图所示**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-04.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-05.webp)  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-06.webp)

**1\. 访问 [https://smee.io/](https://smee.io/)， 点击 `Start a new channel` , 复制生成的Webhook Proxy URL**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-07.webp)
...
结果如图所示  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-08.webp)

**4\. 更换Webhook, Repo --&gt; Setting --&gt; Hooks --&gt; Payload URL 将原先的Jenkins地址更换为smee生成的地址**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-09.webp)

## 四、Jenkins项目测试

**1\. 新建一个项目， 连接到待测试的Repo**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-10.webp)
...
Github 测试  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-11.webp)

Jenkins结果  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-12.webp)

## 五、Pull Request触发Jenkins配置

**1\. 将目标分支设为白名单, 即可在创建PR时就构建项目,**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-13.webp)

**2\. Build Triggers --&gt; GitHub Pull Request Builder --&gt; Whitelist Target Branches --&gt; chao9441/test**

![](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-14.webp)  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-15.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-16.webp)
...
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-17.webp)

**2\. Git设置， 将分支设置主分支**

![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-18.webp)

**3\. 触发器选择Poll SCM, 表示只要主分支代码有任何改动，则触发该项目构建**  
![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-19.webp)  
**4\. 测试结果**

![在这里插入图片描述](/images/posts/【Jenkins】Pull%20Request触发项目构建/image-20.webp)  
