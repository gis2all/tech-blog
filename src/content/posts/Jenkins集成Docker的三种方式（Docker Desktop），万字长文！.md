...
cover: /images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/cover.webp
coverAlt: 在这里插入图片描述
...
输出效果  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-01.webp)  
...
手画的示意图如下  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-02.webp)  
这种方式集成Docker的优缺点
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-03.webp)

##### 1.1.1. Docker Desktop设置

Docker Desktop 启用 `tcp://localhost:2375` 端口，这样允许Docker与Jenkins进行交互

![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-04.webp)  
...
若成功则如下图所示  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-05.webp)  
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-06.webp)  
在未连接的情况下我们可以看到Jenkins有提示我们该如何连接至这个节点，事实上因为Jenkins官方提供的Jenkins子节点镜像中已经做了此项工作，我们只需记住这一步中的secret即可

-   secret - 一串加密字符串  
    ![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-07.webp)
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-08.webp)  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-09.webp)

#### 1.2. Pipeline脚本使用

安装Docker插件  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-10.webp)  
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-11.webp)
...
Jenkins下载Docker插件  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-12.webp)  
**下载SSH Agent，该插件可以实Jenkins现利用ssh动态创建Jenkins节点**  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-13.webp)

##### 2.2.2. 配置Docker云集群

在安装完Docker插件后，在配置节点界面会出现Configure Cloud  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-14.webp)  
**配置本机Docker**
...
-   如果Docker和Jenkins在同一机器上， Docker Host URI输入以下两种情况都可以，若测试连接成功则会出现 Version
    ...
    ![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-15.webp)
...
-   这样也能连接成功  
    ![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-16.webp)
    
#### 2.3. 配置 Docker节点模板

先直接看配置模板  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-17.webp)
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-18.webp)  
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-19.webp)
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-20.webp)
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-21.webp)  
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-22.webp)
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-23.webp)
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-24.webp)  
...
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-25.webp)

**这种方式只支持Jenkins容器运行在Linux系统上的Docker中**

这是目前Docker支持的全局变量参考  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-26.webp)
...
测试效果  
![在这里插入图片描述](/images/posts/Jenkins集成Docker的三种方式（Docker%20Desktop），万字长文！/image-27.webp)
