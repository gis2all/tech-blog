...
cover: /images/posts/【WPF】可用性总结/cover.webp
coverAlt: 在这里插入图片描述
---
...
![在这里插入图片描述](/images/posts/【WPF】可用性总结/image-01.webp)
...
![在这里插入图片描述](/images/posts/【WPF】可用性总结/image-02.mp4)

当然也有例外，对弈UserControl而言，似乎xaml页面的定义不起作用，需要在代码里实现  
![在这里插入图片描述](/images/posts/【WPF】可用性总结/image-03.webp)
