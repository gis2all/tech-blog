...
cover: /images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/cover.webp
coverAlt: 在这里插入图片描述
---
...
MySQL数据类型总表  
![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-01.webp)

### 1\. 数值类型

![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-02.webp)

### 2\. 字符串类型

![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-03.webp)

### 3\. 时间类型

![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-04.webp)

### 3\. 复合类型

![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-05.webp)
...
**测试表chaos-table**  
![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-06.webp)
...
![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-07.webp)

### 1\. 内连接

两张表中拥有相同字段，例如 `服饰表中用户uid` 和 `手机表中用户uid` 相同，通过内连接可以组合两张表中相同的部分，成为一张新表

![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-08.webp)
...
![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-09.webp)
...
![在这里插入图片描述](/images/posts/ji-lu-yi-ci-mysql-de-xue-xi-li-cheng/image-10.webp)
