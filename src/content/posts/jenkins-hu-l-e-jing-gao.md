...
cover: /images/posts/jenkins-hu-l-e-jing-gao/cover.webp
coverAlt: 在这里插入图片描述
---

## 一、问题

![在这里插入图片描述](/images/posts/jenkins-hu-l-e-jing-gao/image-01.webp)
...
![在这里插入图片描述](/images/posts/jenkins-hu-l-e-jing-gao/image-02.webp)  
忽略插件升级或安全警告，转到 `Manage Jenkins => Configure Global Security => Hidden security warnings`，不勾选插件警告  
![在这里插入图片描述](/images/posts/jenkins-hu-l-e-jing-gao/image-03.webp)  
