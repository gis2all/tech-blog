...
本准则适用于「知行」仓库及其社区的所有场合：Issue、Pull Request、代码评审、Discussions，以及站点文章评论区（Giscus）等；参与这些场合即表示同意遵守本准则。

> 本文件采用 [Contributor Covenant][homepage] 2.1 版简体中文译本，仅在「监督」一节填入本项目的举报方式。
...
辱骂、骚扰或其他不可接受的行为可通过邮箱 1262057294@qq.com 向仓库维护者（@gis2all）报告。所有投诉都将得到及时和公平的审查和调查。
